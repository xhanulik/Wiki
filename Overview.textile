...
<b>Attention! Information on this page might be outdated or misleading. If in doubt, ask on [MailingLists opensc-devel mailing list]. Update to the wiki is work in progress. See [[FrequentlyAskedQuestions|Frequently-Asked-Questions]] and [[DeveloperInformation|Creating-applications-with-smart-card-support]] for now.</b>
