 ...
 * CNS-compatible smart cards, running a special CNS version of the "Not found: text(operating system. These cards may have Atehna's ASEPKCS dedicated file, but they support the CNS's own command set.  They should be automatically recognized and handled correctly by the [wiki:ItalianCNS) link(ASEPCOS])":wiki/ASEPCOS] driver;
