 ...
 * "Call for participation (CLOSED)":wiki/FOSDEM2011/CFP in the security devroom.
 ...
 * F (30m, "Tomas Gustavsson":wiki/User:shredder) EJBCA and OpenSC ("mailing list post":http://lists.fosdem.org/pipermail/security-devroom/2010-December/000002.html), [attachment:ejbca-opensc-1.odp presentation]
 * G (30m, "Stef Walter":wiki/User:Stefw) How to Store Trust: Trust Assertions in PKCS#11 ("mailing list post":http://lists.fosdem.org/pipermail/security-devroom/2010-December/000003.html)
 * H (30m, "Nikos Mavrogiannopoulos":wiki/User:nmav) Unifying access to PKCS#11 tokens ("mailing list post":http://lists.fosdem.org/pipermail/security-devroom/2010-December/000004.html)
 * I (30m, "Samuel Lidén Borell":wiki/User:samuellb) Fribid and browser security software ("mailing list post":http://lists.fosdem.org/pipermail/security-devroom/2010-December/000006.html)
 ...
 * K (30m, "Adrien Kunysz":wiki/User:Krunch) BOFH meets SystemTap: rootkits made trivial ("mailing list post":http://lists.fosdem.org/pipermail/security-devroom/2010-December/000011.html)
 * M (15m, Martin Paljak) OpenSC in 2015 - a future vision.
 * N (15m, "Larry Stefonic":wiki/User:lstefonic) CyaSSL "mailing list post":http://lists.fosdem.org/pipermail/security-devroom/2011-January/000015.html)
 ...
 * Kai Engert (NSS)
 * "Larry Stefonic":wiki/User:lstefonic (yaSSL)
 ...
 * "Stef Walter":wiki/User:Stefw (!GnomeKeyring)
 * "Tomas Gustavsson":wiki/User:shredder (EJBCA)
 ...
 * <b>related projects</b> and participants:
  ...
  * "EJBCA":http://ejbca.org (confirmed, "Tomas Gustavsson":wiki/User:shredder)
  ...
  * "GnomeKeyring":http://live.gnome.org/GnomeKeyring/Seahorse (confirmed, "Stef Walter":wiki/User:Stefw)
  ...
  * PLEASE ADD MORE
 * comments
  * Martin: "http://www.opensc-project.org/pipermail/opensc-devel/2010-September/014947.html":http://www.opensc-project.org/pipermail/opensc-devel/2010-September/014947.html
