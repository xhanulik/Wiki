...
Alternatively to hacking `/trac/chrome/site`, you can directly specify path to static resources using `htdocs_location` configuration option in "trac.ini":wiki/The-Trac-Configuration-File:
<pre><code>[trac]
...
----
See also:  TracGuide, TracInstall, "Trac-and-mod_wsgi":wiki/Trac-and-mod_wsgi, TracFastCgi, TracModPython
