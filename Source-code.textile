...
Individual developers also have their own Github trees, "NightlyBuilds":wiki/Automated-OpenSC-builds lists ones that you can get binaries from and "GetInvolved":wiki/Getting-involved-in-OpenSC-development lists all known active developers.
