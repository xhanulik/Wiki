 ...
 * If possible, try again with the latest snapshot version (PreReleases, "NightlyBuilds":wiki/Automated-OpenSC-builds) to see if your problem has already been fixed.
