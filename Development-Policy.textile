...
These small rules for those who "GetInvolved":wiki/Getting-involved-in-OpenSC-development in OpenSC help the project produce consistent and predictable output, if followed. It is not a law set in stone but highly recommended.
 ...
 * Git write access is granted to those who GetInvolved with OpenSC development and
 ...
 * Git rules (see also ReleaseHowto)
  ...
  * Do not mix the branch fed to NightlyBuilds machinery with topic branches. NightlyBuilds branches (except for master builds) are <b>supposed</b> to be rebased or deleted as one sees necessary.
  * Have topic branches.
