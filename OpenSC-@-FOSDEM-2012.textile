...
A reminder to start planning early and to have a booth. "FOSDEM 2011":wiki/OpenSC-@-FOSDEM-2011 was a huge success.
 ...
 * "Call for presentations ":wiki/FOSDEM2012/CFP in the security devroom (a slight modification of 2011 CFP for now, may be updated a bit, but the procedure will remain).
 ...
 * B (30m, "Tomas Gustavsson":wiki/User:shredder) "CESecore and common criteria certification of open source sw":http://cesecore.eu ("mailing list post":https://lists.fosdem.org/pipermail/security-devroom/2011-November/000082.html).
 * C (45m, "Branko Majic":wiki/User:azaghal) "Deployment and Use of X.509 in Free Software Components":http://majic.rs/book/free-software-x509-cookbook (with devroom demo environment if I get some hands on hardware able to run lots of VM's) ("mailing list post":https://lists.fosdem.org/pipermail/security-devroom/2011-November/000083.html)
