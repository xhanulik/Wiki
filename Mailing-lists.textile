 ...
 * Read about <b>"ReportingBugs":How-to-report-bugs-so-that-they-can-be-fixed</b> before sending your e-mail.
...
Please file bug reports using the "Issues":https://github.com/OpenSC/OpenSC/issues link (after reading about "ReportingBugs":How-to-report-bugs-so-that-they-can-be-fixed)
