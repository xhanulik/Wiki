...
Since November 2010 the German government issues new eID cards to citizens ("source":http://www.e-forum.eu/article.php3?id_article=1025). More information can be found on a separate [[wiki page|German-ePass,-ePA]]. 

h2. TeleSec, NetKey cards

!TeleSec GmbH is the manufacturer of [[cards and they offer [[TCOS|TCOS]]|TCOS|TCOS]]]] based signature cards, i.e. NetKey E4 cards. Until the end of 2007 theses card were TCOS2 based with a maximal keylength of 1024 bit. Since October 2007 TeleSec offers 2048 bit signature cards which are TCOS3 based.
...
You will find more information about NetKey cards on a [[separate Wikipage on TCOS based cards|TCOS-based-preformatted-cards]].
