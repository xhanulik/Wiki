 ...
 * Fast: Should be almost as fast as the [[mod_python|Trac-and-mod_python]] version (and much faster than the [wiki:TracCgi CGI]), even more so since version 0.12 where the HTTP/1.1 version of the protocol is enabled by default
