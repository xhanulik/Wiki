 ...
 * Wait around 10 minutes to allow "all builders":https://www.opensc-project.org/autobuild/view/Staging/ in NightlyBuilds machinery to start (polled every 5 minutes) and complete after commiting changes to staging. All builds MUST succeed and MUST NOT generate more warnings than the previous build.
