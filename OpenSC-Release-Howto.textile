 ...
 * _configure.ac_ : Update the "LT version number":https://www.gnu.org/software/libtool/manual/html_node/Updating-version-info.html, which is required with changes to, for example, <pre><code>opensc.h</code></pre> and <pre><code>libopensc.exports</code></pre>.
 ...
 * Upload the build artifacts to the new release (release tarball, OSX installer, 2 variants (default, light) of Windows intaller for both 64b and 32b + separate debug archives)
