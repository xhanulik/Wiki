...
After that we need to create the pkcs15 filesystem and PINs:
    ...
    $ pkcs15-init -C -T -p pkcs15+onepin --pin 123456 --puk 12345678

To generate key pair on the token

    $ pkcs15-init -G rsa/2048 -l "RSA2k key" -a 01 -i 01 --so-pin 12345678 --pin 123456

    $ pkcs15-init -G rsa/2048 -l "RSA2k encryption key" -a 01 -i 02 --pin 123456 -u decrypt
