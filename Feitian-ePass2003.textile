...
For issue was feedback which is "Failed to erase card: Security status not satisfied", Please download fix tool from below, after running fix-tool by root, please do re-plug token/card：
