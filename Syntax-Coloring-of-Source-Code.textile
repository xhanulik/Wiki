...
''[=#a3 (3)] By default `.m` files are considered Objective-C files. In order to treat `.m` files as MATLAB files, add "text/matlab:m" to the "mime_map" setting in the [["[mimeviewer|TracIni#mimeviewer-section]] section of trac.ini"].
