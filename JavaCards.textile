...
[[ListTagged(supported javacard applet)]]
...
| "Not found: text([wiki:e-gate) link(Cyberflex])":wiki/Cyberflex] 32K | 2.1.1 | 2.0.1 | Requires captransf.jar | ? |
 ...
 * "OpenPGP":wiki/OpenPGP-card applet: "http://sourceforge.net/projects/jopenpgpcard/":http://sourceforge.net/projects/jopenpgpcard/ (and a somewhat matching javax.smartcardio GUI "http://sourceforge.net/projects/javaopenpgpcard/)":http://sourceforge.net/projects/javaopenpgpcard/)
