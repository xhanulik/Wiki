...
Trac supports "mod_python":http://www.modpython.org/, which speeds up Trac's response times considerably, especially compared to [TracCgi CGI], and permits use of many Apache features not possible with [[tracd|Tracd]]/mod_proxy.
...
Creating password files and configuring authentication works similar to the process for [[CGI|TracCgi#AddingAuthentication]]:
<pre><code>#!xml
...
----
See also:  TracGuide, TracInstall, [[ModWSGI|Trac-and-mod_wsgi]], [wiki:TracFastCgi FastCGI],  [trac:TracNginxRecipe TracNginxRecipe]
