...
|h1. <b>Category</b> =|= <b>Wiki Markup</b> =|= <b>Display</b>|
|-----------------------------------------------------------
...
|-----------------------------------------------------------
||h1. [#PreformattedText Preformatted Text]||\
<pre><code>#!td {{{
 {{{
...
|-----------------------------------------------------------
||h1. [#DiscussionCitations Discussion Citations]||\
<pre><code>#!td {{{
 >> ... (I said)
 > (he replied)
 </code></pre>
...
| wiki:WikiFormatting, WikiFormatting |
|-----------------------------------------------------------
|h1. [#Images Images]| `!attachments/wiki/WikiFormatting/`<i>link</i>`(WikiFormatting)!` | [[Image(htdocs:../common/trac_logo_mini.png)]] |
|-----------------------------------------------------------
...
|-----------------------------------------------------------
||h1. [#Miscellaneous Miscellaneous]||\
<pre><code>#!td {{{
 Line [[br]] break 
 Line \\ break
 ----
