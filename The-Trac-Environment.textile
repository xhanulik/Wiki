...
"backed up":wiki/Trac-Backup together with the rest of the environment.
 ...
 * `plugins` - Environment-specific "plugins":wiki/Trac-Plugins (Python eggs or single file plugins, since [trac:milestone:0.10 0.10])
