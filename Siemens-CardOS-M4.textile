...
Supported smart cards are the "Aladdin eToken PRO":wiki/Aladdin-eToken-PRO and the [wiki:CryptoIdentityItsec Eutron ITSEC-I] USB tokens.

Currently only the "Aladdin eToken PRO":wiki/Aladdin-eToken-PRO is tested often (a usb crypto dongle that contains a card with this operating system). It works fine, so all other smart cards with the same card operating system should work fine, too.
