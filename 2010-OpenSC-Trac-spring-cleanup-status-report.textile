 ...
 * FAQ - obsolete, new skeleton available in wiki: "FrequentlyAskedQuestions":wiki/Frequently-Asked-Questions DONE
 * History - must be moved to wik DONE: ProjectHistory
 * Contacts - not needed, available on wiki "GetInvolved":wiki/Getting-involved-in-OpenSC-development DONE
 * Projects - must be transferred to the wiki DONE
 * Security - must be transferred to the wiki DONE: "SecurityAdvisories":wiki/OpenSC-security-advisories
