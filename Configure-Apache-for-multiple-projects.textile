...
Start out by creating a project directory in your documentroot (/var/www in this example). Projects will be accessed as "http://hostname/projects/projectname.":http://hostname/projects/projectname. Copy (or symlink) trac.cgi to this directory together with a file named index.html. This will be shown when users try to access nonexistent projects.
...
"tracd":wiki/Tracd and TracModPython can also serve multiple projects.
