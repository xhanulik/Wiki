...
@pkcs15-nit@ also requires to explicitly remove existing key/object. That's why we have @--delete-objects privkey,pubkey --id 3@ in the command.

h3. Import key resp. certificate

h5. Import certificate only
...
h5. Key import via pkcs15-init tool:
...
h5. Import pairs of key & certificate from P12 file:
