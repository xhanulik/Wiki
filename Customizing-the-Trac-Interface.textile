...
The easiest parts of the Trac interface to customize are the logo and the site icon.  Both of these can be configured with settings in [[trac.ini|The-Trac-Configuration-File]].
...
Now configure the appropriate section of your [[trac.ini|The-Trac-Configuration-File]]:
...
For [[mod_python|Trac-and-mod_python]]:
<pre><code>PythonOption TracEnvParentDir /parent/dir/of/projects
PythonOption TracEnvIndexTemplate /path/to/template
</code></pre>

For [[CGI|Installing-Trac-as-CGI]]:
<pre><code>SetEnv TRAC_ENV_INDEX_TEMPLATE /path/to/template
</code></pre>

For [[Tracd|Tracd]], you'll need to set up the `TRAC_ENV_INDEX_TEMPLATE` environment variable in the shell used to launch tracd:
 - Unix
   <pre><code>#!sh
