...
NIST Spical Publication 800-73-3 (See below) and related 
documents define PIV. Part 2 of 800-73-3 defines the ADPU commands accepted 
...
"pkcs11-tool":http://www.opensc-project.org/doc/opensc/html/tools.html#pkcs11-tool can be used
to read the objects on the card and to change the user PIN.   

The "piv-tool":wiki/PivTool is provided to allow for some card administration in testing, such as generating
...
a PKCS#15 emulator to access the certificates and keys, along with the data objects. 
...
The ATR of your card can be read using the "opensc-tool":http://www.opensc-project.org/doc/opensc/html/tools.html#opensc-tool.
