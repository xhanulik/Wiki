...
h2. This is the place for defining InterWiki prefixes
...
<pre><code>prefix <space> URL [<space> # comment]
</code></pre>
...
Note however that <i>deletions</i> are also taken into account immediately,
so it may be better to use comments for disabling prefixes.

Also note that InterWiki prefixes are case insensitive.


h2. List of Active Prefixes
...
<pre><code>PEP     http://www.python.org/peps/pep-$1.html                                       # Python Enhancement Proposal 
