...
Configuring custom ticket fields is done in the [[trac.ini|The-Trac-Configuration-File]] file. All field definitions should be under a section named `[ticket-custom]`.
