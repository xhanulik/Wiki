...
"Not found: text(RPM packages) link(pam_pkcs11/packages)":wiki/pam_pkcs11/packages are available for RedHat/Fedora Distributions, and may not properly install in other distributions.
...
h2. Documentation
  ...
  * Man pages   
    * "pam_pkcs11(8)":wiki/pam_pkcs11/pam_pkcs11
    * "card_eventmgr(1)":wiki/pam_pkcs11/card_eventmgr
    * "pkcs11_eventmgr(1)":wiki/pam_pkcs11/pkcs11_eventmgr
    * "pklogin_finder(1)":wiki/pam_pkcs11/pklogin_finder
    * "pkcs11_inspect(1)":wiki/pam_pkcs11/pkcs11_inspect 

h2. Contact

"GetInvolved":wiki/Getting-involved-in-OpenSC-development in development! All comments, suggestions and bug reports are welcome. 
