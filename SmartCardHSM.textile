The "SmartCard-HSM":http://www.smartcard-hsm.com is a lightweight hardware security module in a smart card form factor. It provides a remote-manageable secure key store for RSA and ECC keys.

The SmartCard-HSM is available as USB stick, ID-1 card with contact/contactless interface, as ID-000 plug-in and MicroSD card. It can be purchased at "authorized resellers":http://www.smartcard-hsm.com/buy.html.
