...
The mantis2trac script now lives at "http://trac-hacks.org/wiki/MantisImportScript.":http://trac-hacks.org/wiki/MantisImportScript. You can always get the latest version from "http://trac-hacks.org/changeset/latest/mantisimportscript?old_path=/&filename=mantisimportscript&format=zip":http://trac-hacks.org/changeset/latest/mantisimportscript?old_path=/&filename=mantisimportscript&format=zip
...
<pre><code>mantis2trac - Imports a bug database from Mantis into Trac.
...
h3. Using a comma delimited file - CSV
...
h3. Using an Excel (.xls) or comma delimited file (.csv)

This plugin "http://trac-hacks.org/wiki/TicketImportPlugin":http://trac-hacks.org/wiki/TicketImportPlugin lets you import into Trac a series of tickets from a CSV file or (if the xlrd library is installed) from an Excel file.
