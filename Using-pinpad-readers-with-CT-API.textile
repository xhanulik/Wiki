h1. Using pinpad readers with CT-API
...
h2. Configuring CT-API in opensc.conf
 ...
 * For some readers you can look up the module name in "pinpad reader overview":wiki/Pinpad-Readers.
...
<pre><code>C:\work\opensc\src\tools>opensc-tool -l
Readers known about:
Nr.    Driver     Name
