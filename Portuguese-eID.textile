...
The "software download page":https://www.cartaodocidadao.pt/index.php_option=com_content&task=view&id=102&Itemid=44&lang=pt.html lists software for Windows, Mac OS X and Linux. Parts of the software are based on OpenSC (custom libopensc provided with the software).
