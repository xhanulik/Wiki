...
The ePass3000 is now superceeded by the [[ePass2003|Feitian-ePass2003]], which offers a CCID interface and therefore requires no proprietary software, altogether on one single chip with a weight of only 6 gramms.
