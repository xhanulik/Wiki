...
"Feitian":http://www.ftsafe.com/ offers the "ePass3000":http://www.ftsafe.com/product/show_product.php?id=25&type=200000, an USB crypto token with 32-bit high performance smart card chip and support for accelerated hardware computation.
...
The ePass3000 is now superceeded by the "ePass2003":wiki/Feitian-ePass2003, which offers a CCID interface and therefore requires no proprietary software, altogether on one single chip with a weight of only 6 gramms.
