...
a problem with that reader. For OpenCT see "https://www.opensc-project.org/opensc/wiki/TroubleShooting":https://www.opensc-project.org/opensc/wiki/TroubleShooting for details.
