...
_HKML\Software\OpenSC\ConfigFile_. If you compile and install OpenSC from
source you need to set this registry key to point to the install file.
Users can set _HKMU\Software\OpenSC\ConfigFile_ to override the system
...
On windows the read PKCS#11 Module is found using _HKLM\Software\PKCS11-Spy\Module_
and the output is written to the file specified in _HKLM\Software\PKCS11-Spy\Output_.
