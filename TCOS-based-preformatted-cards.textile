...
All other trust center that were using TCOS2 cards until the end of 2007 do not offer TCOS based cards anymore. SignTrust now uses [[STARTCOS|STARTCOS]] based card and Datev cards are available to members of Datev only (I doubt they are TCOS based).
...
The following information applies to 1024 bit SignTrust cards only. 2048 bit SignTrust cards do not contain a TCOS chip but are [[3.0 based. Their layout is very similar, but this information won't help OpenSC-users as OpenSC does not support [[STARCOS|STARCOS]]|STARCOS|STARCOS]]]]3.0 as of may 2011.
