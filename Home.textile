...
OpenSC provides a set of libraries and utilities to work with smart cards. Its main focus is on cards that support cryptographic operations, and facilitate their use in security applications such as authentication, mail encryption and digital signatures. OpenSC implements the <b>"PKCS#11 API":http://www.emc.com/emc-plus/rsa-labs/standards-initiatives/pkcs-11-cryptographic-token-interface-standard.htm</b> so applications supporting this API (such as Mozilla Firefox and Thunderbird) can use it. On the card OpenSC implements the "PKCS#15":http://www.emc.com/emc-plus/rsa-labs/standards-initiatives/pkcs-15-cryptographic-token-information-format.htm standard and aims to be compatible with every software/card that does so, too. 
...
If you are new to smart cards, see [[<b>OverView</b>|Overview]] and [[<b>FrequentlyAskedQuestions</b>|Frequently-Asked-Questions]] pages. Always check [[<b>SecurityAdvisories</b>|OpenSC-security-advisories]].

The latest stable version of OpenSC is <b>0.16.0</b> ("released on 03.06.2016":https://sourceforge.net/projects/opensc/files/OpenSC/opensc-0.16.0/)
 * "Source targzip and MSIs":https://sourceforge.net/projects/opensc/files/OpenSC/opensc-0.16.0/
 * "Mac OS X 10.9 and 10.10 installer":https://github.com/OpenSC/OpenSC/releases/download/0.16.0/OpenSC-0.16.0.dmg

The previous stable version of OpenSC was <b>0.15.0</b> ("released on 16.05.2015":https://sourceforge.net/projects/opensc/files/OpenSC/opensc-0.15.0/)
 * "Source targzip and MSIs":https://sourceforge.net/projects/opensc/files/OpenSC/opensc-0.15.0/
 * "Mac OS X 10.9 and 10.10 installer":https://github.com/OpenSC/OpenSC/releases/download/0.15.0/OpenSC-0.15.0.dmg

Nightly and CI builds for Windows are available at "AppVeyor":https://ci.appveyor.com/project/LudovicRousseau/opensc/branch/master See the history to pick the build that matches the latest commit in master.

The oldstable version of OpenSC <b>0.14.0</b> ("released on 26.06.2014":https://sourceforge.net/projects/opensc/files/OpenSC/opensc-0.14.0/)
 * "Source targzip and MSIs":https://sourceforge.net/projects/opensc/files/OpenSC/opensc-0.14.0/

The oldstable version of OpenSC <b>0.13.0</b> ("released on 04.12.2012":https://sourceforge.net/projects/opensc/files/OpenSC/opensc-0.13.0/)
 * "Source targzip and MSIs":https://sourceforge.net/projects/opensc/files/OpenSC/opensc-0.13.0/

The oldstable version of OpenSC <b>0.12.2</b> [milestone:0.12.2 milestone]). See [[<b>DownloadRelease</b>|Download-latest-OpenSC-stable-release]] for detailed information.
 * "Source targzip":http://sourceforge.net/projects/opensc/files/OpenSC/opensc-0.12.2/opensc-0.12.2.tar.gz/download
 * "Windows (x86) installer":http://sourceforge.net/projects/opensc/files/OpenSC/opensc-0.12.2/OpenSC-0.12.2-win32.msi/download (see [[<b>OpenSC Windows Installer</b>|OpenSC-Windows-installer]] for more information)
 * "Windows (x64) installer":http://sourceforge.net/projects/opensc/files/OpenSC/opensc-0.12.2/OpenSC-0.12.2-win64.msi/download
 * "Mac OS X 10.6 and 10.7 installer":http://sourceforge.net/projects/opensc/files/OpenSC/opensc-0.12.2/OpenSC-0.12.2-10.6.dmg/download (see MacInstaller for more information)
 * "Mac OS X 10.5 installer":http://sourceforge.net/projects/opensc/files/OpenSC/opensc-0.12.2/OpenSC-0.12.2-10.5.dmg/download
 ...
 * 03.06.2015: <b>OpenSC 0.16.0</b> is available.
 ...
 * [[<b>OpenSC Windows Installer</b>|OpenSC-Windows-installer]]