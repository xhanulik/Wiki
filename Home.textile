...
The latest stable version is "OpenSC 0.16.0":https://github.com/OpenSC/OpenSC/releases/tag/0.16.0 released on 04.06.2016. It is available as
 * "Source code distribution":https://github.com/OpenSC/OpenSC/releases/download/0.16.0/opensc-0.16.0.tar.gz
 * Windows Installer for "64 bit":https://github.com/OpenSC/OpenSC/releases/download/0.16.0/OpenSC-0.16.0-win32_vs12-Release.msi and "32 bit":https://github.com/OpenSC/OpenSC/releases/download/0.16.0/OpenSC-0.16.0-win64_vs12-Release.msi operating system
 * "macOS installer":https://github.com/OpenSC/OpenSC/releases/download/0.16.0/OpenSC-0.16.0.dmg
