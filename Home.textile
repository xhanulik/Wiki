OpenSC provides a set of libraries and utilities to work with smart cards. Its main focus is on cards that support cryptographic operations, and facilitate their use in security applications such as authentication, mail encryption and digital signatures. OpenSC implements the standard APIs to smart cards, e.g. "PKCS#11 API":https://www.oasis-open.org/committees/pkcs11/, "Windows' Smart Card Minidriver":https://msdn.microsoft.com/en-us/library/windows/hardware/dn631754%28v=vs.85%29.aspx and macOS CryptoTokenKit.

h2. Download

"OpenSC 0.21.0":https://github.com/OpenSC/OpenSC/releases/tag/0.21.0 is the latest stable version released on 24.11.2020. It is available as
 * Windows installer
  ** "OpenSC-0.21.0_win64.msi":https://github.com/OpenSC/OpenSC/releases/download/0.21.0/OpenSC-0.21.0_win64.msi for 64 bit programs
  ** "OpenSC-0.21.0_win32.msi":https://github.com/OpenSC/OpenSC/releases/download/0.21.0/OpenSC-0.21.0_win32.msi for 32 bit programs
 * "OpenSC-0.21.0.dmg":https://github.com/OpenSC/OpenSC/releases/download/0.21.0/OpenSC-0.21.0.dmg: macOS installer
 * "opensc-0.21.0.tar.gz":https://github.com/OpenSC/OpenSC/releases/download/0.21.0/opensc-0.21.0.tar.gz: Source code distribution
