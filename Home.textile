...
Nightly and CI builds for Windows are available at "AppVeyor":https://ci.appveyor.com/project/LudovicRousseau/opensc
See the history to pick the build that matches the latest commit in master.
