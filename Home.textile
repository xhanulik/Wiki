...
"OpenSC 0.18.0":https://github.com/OpenSC/OpenSC/releases/tag/0.19.0 is the latest stable version released on 13.09.2018. It is available as
 * Windows installer
  ** for "64 bit 'OpenSC-win64_0.19.0.msi'":https://github.com/OpenSC/OpenSC/releases/download/0.19.0/OpenSC-win64_0.19.0.msi and
  ** for "32 bit 'OpenSC-win32_0.19.0.msi'":https://github.com/OpenSC/OpenSC/releases/download/0.19.0/OpenSC-win32_0.19.0.msi programs
 * "macOS installer 'OpenSC-0.19.0.dmg'":https://github.com/OpenSC/OpenSC/releases/download/0.19.0/OpenSC-0.19.0.dmg
 * "Source code distribution 'opensc-0.19.0.tar.gz'":https://github.com/OpenSC/OpenSC/releases/download/0.19.0/opensc-0.19.0.tar.gz
 ...
 * 13.09.2018: <b>SECURITY</b>: Response APDU handling issues prior to 0.19.0 (CVE-2018-16391, CVE-2018-16392, CVE-2018-16393, CVE-2018-16418, CVE-2018-16419, CVE-2018-16420, CVE-2018-16421, CVE-2018-16422, CVE-2018-16423, CVE-2018-16424, CVE-2018-16425, CVE-2018-16426, CVE-2018-16427), see [[OpenSC-security-advisories]].
 ...
 * 17.12.2010: <b>SECURITY</b>: Response APDU handling issues prior to 0.12.0 (CVE-2010-4523), see [[OpenSC-security-advisories]].
