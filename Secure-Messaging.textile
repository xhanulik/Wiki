...
Secure Messaging (SM) provides end-to-end security of the communication between ICC and off-card entity by adding configentiality, integrity and authentication to the APDU transactions.
