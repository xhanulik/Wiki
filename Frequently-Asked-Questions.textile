...
A: Check the "SupportedHardware":wiki/Supported-hardware-(smart-cards-and-USB-tokens) list. Verify it with _opensc-tool --name_ to see if some driver knows how to handle your card. The expected result of the command is a line with a card driver name.
 ...
 * "http://www.aventra.fi":http://www.aventra.fi - ships from Finland, "Aventra-MyEID-PKI-card":wiki/Aventra-MyEID-PKI-card card
 * "http://www.cryptoshop.com":http://www.cryptoshop.com - ships from Austria
 * "http://www.gooze.eu":http://www.gooze.eu - ships from France, Feitian "card":wiki/Feitian-PKI-card and [wiki:feitian-pki-token token]
 * "http://shop.kernelconcepts.de/":http://shop.kernelconcepts.de/ - ships from Germany, "OpenPGP v2 card":wiki/OpenPGP-card and CryptoStick token
