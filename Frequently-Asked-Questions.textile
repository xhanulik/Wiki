...
A: Check the SupportedHardware list. Verify it with _opensc-tool --name_ to see if some driver knows how to handle your card. The expected result of the command is a line with a card driver name.
