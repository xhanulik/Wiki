 ...
 * "https://javacardos.com":https://javacardos.com/store/ -  JavaCardOS is dedicated to building a comprehensive Java Card platform in order to construct a complete ecosystem for smart card applications.
