...
DNIe support got merged by code from the OpenDNIe fork. The code is now in Master. OpenSC software which you can download from this website still does <b>NOT</b> support the Spanish Ceres cards.
