 ...
 * C
  * "libp11":wiki/libp11-PKCS%2311-wrapper-library is a simple wrapper around PKCS#11, written in C. It support only RSA keys and PKCS#1 padding.
  * "pkcs11-helper":wiki/pkcs11-helper is a wrapper around PKCS#11 modules written in C. It also includes an OpenSSL engine.
  * "engine_pkcs11":wiki/OpenSSL-engine-for-PKCS%2311-modules is a stand-alone OpenSSL engine that bridges OpenSSL and PKCS#11. SSL connections can be terminated with keys from a PKCS#11 module. As it is based on libp11, it only supports what libp11 supports (RSA-PKCS#1)
  ...
  * "p11-kit":http://p11-glue.freedesktop.org/p11-kit.html eases working with multiple PKCS#11 modules and includes support for "PKCS#11 URI scheme":http://tools.ietf.org/html/draft-pechanec-pkcs11uri-04.
 * Python
  * "PyKCS11":http://www.bit4id.org/trac/pykcs11 is a python wrapper (SWIG) for PKCS#11 modules.
 * Java 
  * "Using-smart-cards-with-Java-SE":wiki/Using-smart-cards-with-Java-SE wiki page has more resources on Java and smart cards, including a list of PKCS#11 wrappers
...
* TODO, but "Using-smart-cards-with-Java-SE":wiki/Using-smart-cards-with-Java-SE has some pointers
...
"GnuTLS":http://www.gnu.org/software/gnutls/ includes native PKCS#11 smart card support.
See "http://www.gnu.org/software/gnutls/manual":http://www.gnu.org/software/gnutls/manual for more information. 
 ...
 * Java
  * See "dedicated Java page":wiki/Using-smart-cards-with-Java-SE about javax.smartcardio in Java 1.6+
